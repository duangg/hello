...
public class LoginThread extends Thread{
    ...
    public LoginThread(CloseableHttpClient client, BlockingQueue<Integer> idQueue) {
        this.client = client;
    ...
    public void run() {
        ...
        try {
            while ((id = idQueue.take()) > 0) {
                ...
                HttpPost post = new HttpPost("http://10.5.140.15:10000/foundation/passport/login");
